...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المرضى</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ معلومات
                    المريض</span>
            </div>
        </div>
    </div>
                            ...
                            <div class="panel panel-primary tabs-style-1">
                                ...
                                <div class="panel-body tabs-menu-body main-content-body-right border-top-0 border">
                                    <div class="tab-content">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th colspan="2" scope="row"
                                                                class="alert alert-success text-right">الاجمالي
                                                            </th>
                                                            <td class="alert alert-primary">
                                                                {{ number_format($receipt_accounts->sum('Debit'), 2) }}
                                                            </td>
                                                            <td class="alert alert-success"></td>
                                                        </tr>
                                                    </tbody>
                                        ...
                                        @php
                                            $debit = $Patient_accounts->sum('Debit');
                                            $credit = $Patient_accounts->sum('credit');
                                                ...
                                                <table class="table table-hover text-md-nowrap text-center" id="example1">
                                                    ...
                                                    <tbody>
                                                        @foreach ($Patient_accounts as $Patient_account)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @elseif($Patient_account->receipt_account_id)
                                                                        {{ $Patient_account->ReceiptAccount->description }}
                                                                    @elseif($Patient_account->payment_account_id)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="alert alert-primary">{{ number_format($debit, 2) }}
                                                            </td>
                                                            <td class="alert alert-primary">{{ number_format($credit, 2) }}
                                                            </td>
