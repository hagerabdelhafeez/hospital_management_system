        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    </svg><span class="side-menu__label">{{ trans('dashboard/main-sidebar_trans.doctors') }}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
                            href="{{ route('doctors.index') }}">{{ trans('dashboard/main-sidebar_trans.view_all') }}</a>
                    </li>
                </ul>
            </li>
            <li class="side-item side-item-category">General</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">{{ trans('dashboard/main-sidebar_trans.Services') }}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
                            href="{{ route('services.index') }}">{{ trans('dashboard/main-sidebar_trans.Single_service') }}</a>
                    </li>
                    <li><a class="slide-item"
                            href="{{ route('Add_GroupServices') }}">{{ trans('dashboard/main-sidebar_trans.group_services') }}</a>
                    </li>
                    <li><a class="slide-item"
                            href="{{ route('insurances.index') }}">{{ trans('dashboard/main-sidebar_trans.Insurance') }}</a>
                    </li>
                    <li><a class="slide-item"
                            href="{{ route('ambulances.index') }}">{{ trans('dashboard/main-sidebar_trans.ambulance') }}</a>
                    </li>
                    <li><a class="slide-item"
                            href="{{ url('/' . ($page = 'calendar')) }}">{{ trans('dashboard/main-sidebar_trans.Ambulance_calls') }}</a>
                    </li>
                </ul>
            </li>
            <li class="slide">
